<?php
namespace Mamarmite\Sharing\Templates;

/**
 * Template Loader for Plugins.
 * From Gamajo_Template_Loader, Gary Jones http://github.com/GaryJones/Gamajo-Template-Loader version 1.3.1
 */
...
class TemplateLoader
{
     ...
     * @var string
     */
    protected $theme_template_directory = 'mamarmite-sharing';
     ...
     * @var string
     */
    protected $plugin_directory;//set in construct
    ...
    {
        $this->plugin_directory = Config::$PLUGIN_BASE_FILEPATH;
    }
